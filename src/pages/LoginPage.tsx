    ...
    <Layout>
      <div className="max-w-md mx-auto bg-white rounded-lg overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md">
        <div className="px-6 py-8">
          <h2 className="text-2xl font-medium text-center text-gray-900 mb-8">Log in to your account</h2>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/register" className="font-medium text-blue-500 hover:text-blue-600 transition-colors duration-200">
                Sign up
              </Link>
            </p>
          </div>
